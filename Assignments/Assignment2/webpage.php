...
$pText = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
	...
	Fusce aliquet bibendum erat, sed bibendum eros cursus eu. Nulla at neque rhoncus, ultricies odio at, 
	accumsan elit. Proin in turpis eu leo dapibus pulvinar. Vivamus viverra massa ut enim fringilla ultricies. 
	Donec in enim blandit, iaculis nulla quis, egestas elit. Nullam ut enim id erat bibendum finibus nec ac eros. 
	Nulla malesuada ex facilisis ultrices rhoncus. 
	Nullam in euismod nisl. Donec pulvinar ex sit amet aliquet egestas.";
$footer = "My Web Page ©2021";
$myName = "Matt Boone";

function printThrice($content) {
	for($i = 3; $i > 0; $i--) {
		echo "<p>" . 
		$content . 
		"</p>";
